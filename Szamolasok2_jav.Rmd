...
*Ezt technikailag a következő ötlettel fogjuk meg: Ha a jól specifikáltság H0-ja igaz, és nem hagytam ki nem-lineáris hatást, akkor, ha az eredeti regresszióm becsült eredményváltozó értékeinek (képletben az Y kalapoknak) négyzetét és köbét beveszem a regresszióba, mint extra két magyarázóváltozó, akkor e két változó együtthatója 0 lesz--> a lineáris becslésen végzett nem-lineáris transzformációk nem adnak extra magyarázóerőt a jól specifikált modellnek.*
